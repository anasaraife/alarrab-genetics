# ===================================================================
# 🕊️ العرّاب للجينات V44.0 - إصلاح نهائي للمساعد الذكي
# تم تحديث اسم نموذج Gemini إلى نموذج حديث ومدعوم
# ===================================================================
...
def get_gemini_response(query):
    try:
        ...
        # ==========================================================
        # تم تحديث اسم النموذج إلى نموذج حديث ومدعوم
...
# --- 5. واجهة التطبيق ---
st.title("🕊️ العرّاب للجينات (V44 - إصلاح نهائي)")
